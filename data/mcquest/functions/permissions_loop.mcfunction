...
effect give @a[team=,gamemode=adventure] minecraft:regeneration 2 255 true
effect give @a[team=,gamemode=adventure] minecraft:resistance 2 255 true
effect give @a[team=,gamemode=adventure] minecraft:weakness 2 255 true
# Bars
