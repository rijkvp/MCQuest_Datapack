...
execute unless data entity @s[team=] SelectedItem[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:2}}] run scoreboard players set @s select 5
...
execute unless data entity @s[team=] SelectedItem[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:3}}] run scoreboard players set @s select 3
